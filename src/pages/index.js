  ...
  return (
    <>
      ...
      <div className={styles["home_hero"]}>
        <h1 className={styles.title}>Welcome to Foo Festival!</h1>
        <p className={styles.text}>
          {/* Intro text generated by ChatGPT. */}
          Get ready to immerse yourself in a world of enchantment and celebration as we bring you the most extraordinary festival experience yet. From breathtaking performances to vibrant cultural displays, Foo Festival is your gateway to a journey
          filled with joy, wonder, and unforgettable memories.
        </p>
        <p className={styles.text}>
          Join us in several locations, where the air is alive with anticipation and the energy is contagious. As you step foot into our festival grounds, you'll be greeted by a kaleidoscope of colors, the tantalizing aroma of delicious food, and the
          melodic sounds of talented musicians from around the globe.
        </p>
      ...
      <section className={styles.home_program}>
        <p className={styles.text}>
          Prepare to be mesmerized by our world-class performances that will transport you to new realms. From captivating dance performances to spellbinding theatrical productions, every moment is designed to ignite your imagination and leave you
          breathless.
          <br /> <br /> Let the rhythmic beats and soul-stirring melodies move your spirit as you dance the night away in the company of fellow festival-goers.
          <br /> <br />
          Join thousands of rock enthusiasts and let the rhythm take over. <br /> <br /> Don't miss out! Secure your spot and buy your tickets now.
        </p>
      </section>
