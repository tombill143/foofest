    ...
    <>
      ...
      <section className={styles.home_program}>
        <p className={styles.text}>
          Get ready for the ultimate rock experience at Foofest - The Rock Festival! Immerse yourself in a deep forest setting as you rock out to electrifying performances by renowned bands. With XX days of non-stop music, Foofest guarantees an
          unforgettable experience. Join thousands of rock enthusiasts and let the rhythm take over. Don't miss out! Secure your spot and buy your tickets now.
        </p>
      </section>
      <div className={styles.buttonContainer}>
        <button className={styles.button}>
          <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
